...
units = [
    {"id": "U01", "number": 1, "name": "الأدب في العصر الجاهلي", "lessons": [
        {"id": "L01", "number": 1, "name": "المعلقات", "file": "unit-01/lesson-01.json"},
        {"id": "L02", "number": 2, "name": "فن الخطابة", "file": "unit-01/lesson-02.json"}
    ]},
    {"id": "U02", "number": 2, "name": "الأدب في صدر الإسلام والأموي", "lessons": [
        {"id": "L01", "number": 1, "name": "الخطابة في صدر الإسلام", "file": "unit-02/lesson-01.json"}
    ]}
]
...
save_json("index.json", {"subject_id": "arabic", "subject": "اللغة العربية", "generation_id": "2009", "generation": "2009", "semester_id": "semester-1", "semester": 1, "semester_label": "ف1", "units": index_units})
