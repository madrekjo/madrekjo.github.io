...
export const useUnloadCleanup = () => {
  ...
  useEffect(() => {
    ...
    const url = (window.CONFIG?.supabaseUrl || import.meta.env.VITE_SUPABASE_URL) as string;
    const apikey = (window.CONFIG?.supabaseAnonKey || import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY) as string;
