...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_support_admin_ids: { Args: never; Returns: string[] }
      get_user_successful_tasks: {
      ...
      leave_active_rounds: { Args: never; Returns: undefined }
    }
    Enums: {
      app_role: "admin" | "user"
      task_category: "daily" | "weekly" | "monthly"
    }
    CompositeTypes: {
      [_ in never]: never
    }
