  ...
  public: {
    Tables: {
      ...
      teacher_field_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "teacher_field_links_field_id_fkey";
            columns: ["field_id"];
            isOneToOne: false;
            referencedRelation: "teacher_fields";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "teacher_field_links_teacher_id_fkey";
            columns: ["teacher_id"];
            isOneToOne: false;
            referencedRelation: "teachers";
            referencedColumns: ["id"];
      ...
      teacher_grade_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "teacher_grade_links_grade_id_fkey";
            columns: ["grade_id"];
            isOneToOne: false;
            referencedRelation: "teacher_grades";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "teacher_grade_links_teacher_id_fkey";
            columns: ["teacher_id"];
            isOneToOne: false;
            referencedRelation: "teachers";
            referencedColumns: ["id"];
      ...
      teacher_contents: {
        ...
        Relationships: [
          {
            foreignKeyName: "teacher_contents_section_id_fkey";
            columns: ["section_id"];
            isOneToOne: false;
